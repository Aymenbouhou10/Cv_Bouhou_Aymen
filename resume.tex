...
\photo[circle,noedge,left]{mer.png}
\name{Aymen}{BOUHOU}
\position{Étudiant en M2 Machine Learning pour la Data Science à la recherche d'un stage à partir du 1er mars}
\address{Nanterre, Île-de-France}


\mobile{06 52 25 04 85}

\email{aymen.bouhou@etu.u-paris.fr}

%\homepage{www.posquit0.com} 
\github{github.com/Aymenbouhou10}
\linkedin{linkedin.com/in/aymenbouhou/}
% \gitlab{gitlab-id}
